...
Source: [App.svelte](../../apps/web/src/App.svelte), [Editor.svelte](../../apps/web/src/lib/Editor.svelte), [Board.svelte](../../apps/web/src/lib/Board.svelte), [CalendarView.svelte](../../apps/web/src/lib/CalendarView.svelte), [GanttView.svelte](../../apps/web/src/lib/GanttView.svelte), [Settings.svelte](../../apps/web/src/lib/Settings.svelte).
...
Source basis: [card fields and limits](../../docs/03-DATA-FORMAT.md), [current label input and serialization](../../apps/web/src/lib/Editor.svelte), [list filter API](../../contracts/openapi.yaml). Existing label limits remain relevant: at most 20 labels per card and 48 characters per label. A future tag design must either respect these limits or deliberately revise the shared contracts; a frontend-only divergence is not acceptable.
