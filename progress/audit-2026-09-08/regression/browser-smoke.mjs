...
try {
  ...
  console.log("AUDIT browser version:", browser.version());
  ...
  await mkdir(join(root, "progress/audit-2026-09-08/regression/screenshots"), { recursive: true });
  console.log("AUDIT checkpoint 1: before screenshot in browser-smoke.mjs");
  await page.screenshot({
    path: join(root, "progress/audit-2026-09-08/regression/screenshots/desktop-board.png"),
    fullPage: true,
  });
  ...
  console.log("AUDIT checkpoint 2: before screenshot in browser-smoke.mjs");
  await mobile.screenshot({
    path: join(root, "progress/audit-2026-09-08/regression/screenshots/mobile-conflict.png"),
    fullPage: true,
  });
  ...
  console.log("AUDIT checkpoint 3: before screenshot in browser-smoke.mjs");
  await page.screenshot({path:join(root,"progress/audit-2026-09-08/regression/screenshots/desktop-timeline.png"),fullPage:true});
  ...
  console.log("AUDIT checkpoint 4: before screenshot in browser-smoke.mjs");
  await page.screenshot({path:join(root,"progress/audit-2026-09-08/regression/screenshots/board-drag-preview.png"),fullPage:true});
  await page.mouse.up();
  ...
  console.log("AUDIT checkpoint 5: before screenshot in browser-smoke.mjs");
  await page.screenshot({path:join(root,"progress/audit-2026-09-08/regression/screenshots/desktop-board.png"),fullPage:true});
  ...
  console.log("AUDIT checkpoint 6: before screenshot in browser-smoke.mjs");
  await page.screenshot({path:join(root,"progress/audit-2026-09-08/regression/screenshots/desktop-board-dark.png"),fullPage:true});
  await page.evaluate(() => document.documentElement.dataset.theme = "light");
  await page.setViewportSize({width:390,height:844});
  await page.evaluate(() => window.scrollTo(0,0));
  console.log("AUDIT checkpoint 7: before screenshot in browser-smoke.mjs");
  await page.screenshot({path:join(root,"progress/audit-2026-09-08/regression/screenshots/mobile-board.png"),fullPage:true});
  ...
  await page.reload();
  await assertRestored();
  console.log("AUDIT checkpoint 8: before screenshot in browser-smoke.mjs");
  await page.screenshot({path:join(root,"progress/audit-2026-09-08/regression/screenshots/board-remembered-view.png"),fullPage:true});
  ...
  console.log("AUDIT checkpoint 9: before screenshot in browser-smoke.mjs");
  await page.screenshot({path:join(root,"progress/audit-2026-09-08/regression/screenshots/gantt-waterfall.png"),fullPage:true});
  ...
  console.log("AUDIT checkpoint 10: before screenshot in browser-smoke.mjs");
  await page.screenshot({path:join(root,"progress/audit-2026-09-08/regression/screenshots/calendar-week.png"),fullPage:true});
  ...
  console.log("AUDIT checkpoint 11: before screenshot in browser-smoke.mjs");
  await page.screenshot({path:join(root,"progress/audit-2026-09-08/regression/screenshots/desktop-dark.png"),fullPage:true});
  await page.reload();
  await page.getByRole("heading",{name:"List.",exact:true}).waitFor();
  assert.equal(await page.evaluate(() => getComputedStyle(document.documentElement).colorScheme),"dark");
