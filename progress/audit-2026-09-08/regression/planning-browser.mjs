...
try {
  ...
  await page
    ...
    .waitFor();
  console.log("AUDIT checkpoint 1: before screenshot in planning-browser.mjs");
  await page.screenshot({
    path: join(root, "progress/audit-2026-09-08/regression/screenshots/gantt-project.png"),
    fullPage: true,
  });
  ...
  console.log("AUDIT checkpoint 2: before screenshot in planning-browser.mjs");
  await page.screenshot({
    path: join(root, "progress/audit-2026-09-08/regression/screenshots/gantt-forecast.png"),
    fullPage: true,
  });
  ...
  console.log("AUDIT checkpoint 3: before screenshot in planning-browser.mjs");
  await page.screenshot({
    path: join(root, "progress/audit-2026-09-08/regression/screenshots/calendar-project.png"),
    fullPage: true,
  });
  const baseline = cli(
    "get",
  ...
  await locator().waitFor();
  console.log("AUDIT checkpoint 4: before screenshot in planning-browser.mjs");
  await page.screenshot({
    path: join(root, "progress/audit-2026-09-08/regression/screenshots/calendar-day.png"),
    fullPage: true,
  });
  await page
    .getByLabel("Calendar layout", { exact: true })
  ...
  console.log("AUDIT checkpoint 5: before screenshot in planning-browser.mjs");
  await page.screenshot({
    path: join(root, "progress/audit-2026-09-08/regression/screenshots/calendar-agenda.png"),
    fullPage: true,
  });
  await page.evaluate(() => {
  ...
  await page
    .getByLabel("Calendar layout", { exact: true })
    .selectOption("month");
  console.log("AUDIT checkpoint 6: before screenshot in planning-browser.mjs");
  await page.screenshot({
    path: join(root, "progress/audit-2026-09-08/regression/screenshots/calendar-dark.png"),
    fullPage: true,
  });
  await page.getByRole("button", { name: "Timeline", exact: true }).click();
  await page
    ...
    .waitFor();
  console.log("AUDIT checkpoint 7: before screenshot in planning-browser.mjs");
  await page.screenshot({
    path: join(root, "progress/audit-2026-09-08/regression/screenshots/gantt-dark.png"),
    fullPage: true,
  });
  ...
  console.log("AUDIT checkpoint 8: before screenshot in planning-browser.mjs");
  await page.screenshot({
    path: join(root, "progress/audit-2026-09-08/regression/screenshots/gantt-narrow.png"),
    fullPage: true,
  });
  ...
  if (activePage) {
    await activePage.screenshot({
      path: join(root, "progress/audit-2026-09-08/regression/screenshots/planning-failure.png"),
      fullPage: true,
    });
